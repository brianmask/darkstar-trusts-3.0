...
PARIKE_PORANKE_DIALOG = 8949; -- All these people running back and forth... There have to be a few that have munched down more mithkabobs than they can manage.
    WAYPOINT_EXAMINE = 10340; -- An enigmatic contrivance hovers in silence...
       ...
       PARIKE_PORANKE_4 = 8955; -- Now stand still! You wouldn't want your pelvis to implode, would you? (Let's see... What were those magic words again...?)
       PARIKE_PORANKE_5 = 8956; -- Ready? No? Well, too bad!
       PARIKE_PORANKE_6 = 8964; -- digestive magic skill rises 0.1 points.
       PARIKE_PORANKE_7 = 8965; -- digestive magic skill rises one level.
       PARIKE_PORANKE_8 = 8966; -- Heh heh! I think I'm starting to get the hang of this spellcasting.
       PARIKE_PORANKE_9 = 8967; -- Consider this a petite present from your pal Parike-Poranke!
      PARIKE_PORANKE_10 = 8971; -- Wait a minute... Don't tell me you came to Parike-Poranke on an empty stomach! This is terrible! The minister will have my head!
      PARIKE_PORANKE_12 = 8973; -- Phew! That was close... What were you thinking, crazy adventurer!
FIXME: FIXME:       PARIKE_PORANKE_13 = 8973; -- Speaker Name's ll in the name of scienceskill rises 0.1 points.
FIXME: FIXME:       PARIKE_PORANKE_14 = 8974; -- Speaker Name's ll in the name of scienceskill rises one level.
...
-- Shop Texts
 CREEPSTIX_SHOP_DIALOG = 7126; -- Hey, how ya doin'? We got the best junk in town.
  STINKNIX_SHOP_DIALOG = 7126; -- Hey, how ya doin'? We got the best junk in town.
     HASIM_SHOP_DIALOG = 7127; -- Welcome to Waag-Deeg's Magic Shop.
      TAZA_SHOP_DIALOG = 7127; -- Welcome to Waag-Deeg's Magic Shop.
      SUSU_SHOP_DIALOG = 7127; -- Welcome to Waag-Deeg's Magic Shop.
    CHETAK_SHOP_DIALOG = 7128; -- Welcome to Othon's Garments.
  CHENOKIH_SHOP_DIALOG = 7128; -- Welcome to Othon's Garments.
   YOSKOLO_SHOP_DIALOG = 7129; -- Welcome to the Merry Minstrel's Meadhouse. What'll it be?
 ADELFLETE_SHOP_DIALOG = 7130; -- Here at Gems by Kshama, we aim to please.
   MOREFIE_SHOP_DIALOG = 7130; -- Here at Gems by Kshama, we aim to please.
   MATOAKA_SHOP_DIALOG = 7130; -- Here at Gems by Kshama, we aim to please.
  RHIMONNE_SHOP_DIALOG = 7133; -- Howdy! Thanks for visiting the Chocobo Shop!
   PAWKRIX_SHOP_DIALOG = 7630; -- Hey, we're fixin' up some stew. Gobbie food's good food!
AMALASANDA_SHOP_DIALOG = 7678; -- Welcome to the Tenshodo. You want something, we got it. We got all kinds of special merchandise you won't find anywhere else!
 AKAMAFULA_SHOP_DIALOG = 7679; -- We ain't cheap, but you get what you pay for! Take your time, have a look around, see if there's somethin' you like.

-- conquest Base
CONQUEST_BASE = 6540; -- Tallying conquest results...

-- Porter Moogle
    RETRIEVE_DIALOG_ID = 10181; -- You retrieve$ from the porter moogle's care.
