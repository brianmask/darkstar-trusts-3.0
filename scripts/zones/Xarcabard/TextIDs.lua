...
ITEM_CANNOT_BE_OBTAINED = 6393; -- You cannot obtain the item <item>. Come back after sorting your inventory.
          ITEM_OBTAINED = 6399; -- Obtained: <item>.
           GIL_OBTAINED = 6400; -- Obtained <number> gil.
...
-- Other
NOTHING_OUT_OF_ORDINARY = 6413; -- There is nothing out of the ordinary here.
...
-- Dynamis dialogs
       YOU_CANNOT_ENTER_DYNAMIS = 7841; -- You cannot enter Dynamis
 PLAYERS_HAVE_NOT_REACHED_LEVEL = 7843; -- Players who have not reached levelare prohibited from entering Dynamis
 UNUSUAL_ARRANGEMENT_OF_PEBBLES = 7854; -- There is an unusual arrangement of pebbles here.
